        ...
        <div class="relative lg:w-1/2 w-full m-auto px-10 lg:px-20 mt-20 justify-items-center bg-gray-50 rounded-xl p-4 shadow-md">
            ...
            <form class="space-y-6" action="<?= base_url('user/tambah_aksi_testimoni'); ?>" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <textarea id="review" name="review" rows="4" placeholder="Harap masukkan review anda dengan jujur dan sepenuh hati" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-100 rounded-lg border border-gray-300 focus:ring-amber-500 focus:border-amber-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-amber-500 dark:focus:border-amber-500"></textarea>
                ...
                <div>
                    ...
                    <label class="block mb-2 text-sm font-medium text-red-900 ">*harap inputkan gambar review produk anda!</label>
                </div>
