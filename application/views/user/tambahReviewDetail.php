    ...
    <div class="pt-24 px-3">
        <div class="relative lg:w-1/2 w-full m-auto px-10 lg:px-20 mt-20 justify-items-center bg-gray-50 rounded-xl p-4 shadow-md">
            ...
            <?php foreach ($produk as $pdk) : ?>
                ...
                <!-- FORM -->
                <form class="space-y-6" action="<?= base_url('user/tambah_aksi_testimoni_detail'); ?>" method="post" enctype="multipart/form-data">

                    <input type="hidden" name="id_product" id="id_product" value="<?= $pdk->id ?>">
